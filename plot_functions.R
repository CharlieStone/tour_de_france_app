...
plot_route_year <- function(loc_single, cyc_single, not_cyc_single){
...
plot_route_range <- function(loc_range, cyc_range, not_cyc_range, loc_single, cyc_single, not_cyc_single){
